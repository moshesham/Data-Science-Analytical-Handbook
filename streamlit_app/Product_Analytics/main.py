...
def main():
    ...
    st.write(
        "This interactive platform is designed to help you learn and practice key concepts in product analytics. Use the navigation bar on the left to explore the various topics."
    )
    ...
    st.markdown(
        "To begin your journey, navigate to the `Data Fundamentals` page. From there, continue through the different topics in order for the most comprehensive experience."
    )

    st.markdown("## About the Project")
    st.markdown(
        "This project is designed to be an interactive platform for learning the key concepts of Product Analytics. It is meant to be an interactive learning tool with practical examples and real world applications to enhance your knowledge."
    )
