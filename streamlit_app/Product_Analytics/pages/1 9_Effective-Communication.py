...
def main():
    st.set_page_config(
        page_title="Problem Decomposition & Effective Communication",
        page_icon="🧩🗣️",
        layout="wide",
    )
    ...
    st.write(
        "Learn to break down daunting challenges and communicate solutions with clarity and impact."
    )
    ...
    complex_task = st.text_area(
        "Enter a Complex Task or Problem:",
        "Plan and execute a comprehensive marketing campaign for a new product launch.",
    )

    if complex_task:
        st.write("Let's decompose this task using a top-down approach:")
        level1_tasks = st.text_input(
            "Level 1 Sub-Tasks (comma-separated, e.g., Research, Strategy, Execution):",
        ...
        if level1_tasks:
            ...
            for task1 in task_list_level1:
                ...
                level2_tasks = st.text_input(
                    f"  Level 2 Sub-Tasks for '{task1}' (comma-separated):",
                    key=f"level2_{task1}",
                )
                if level2_tasks:
                    task_list_level2 = [
                        task.strip() for task in level2_tasks.split(",")
                    ]
    ...
    technical_explanation = st.text_area(
        "Enter a Technical Finding or Explanation:",
    ...
    if technical_explanation:
        ...
        st.write(
            "- **Non-Technical:** Focus on business impact, key takeaways, and avoid jargon."
        )
        st.write(
            "- **Technical:** Can include technical details, metrics, and methodology, assuming a shared understanding."
        )
    ...
    quiz_questions = [
        {
            ...
            "options": [
                "Increases cognitive overwhelm",
                "Obscures problem components",
                "Facilitates planning and collaboration",
                "Makes resource allocation harder",
            ],
        ...
        },
        {
            ...
            "options": [
                "Start with detailed data, then conclusions",
                "Start with the main conclusion, then supporting arguments",
                "Structure communication chronologically",
        ...
        },
        {
            ...
            "options": [
                ...
                "Ignoring all complexities",
                "Focusing on essential details and ignoring irrelevant complexities",
                "Solving a problem using only visual tools",
            ],
        ...
        },
        {
            ...
            "options": [
                ...
                "Recursively break down problems into independent sub-problems",
                "Use only top-down approach",
                "Ignore complex parts of the problem",
            ],
        ...
        },
        {
            ...
            "options": [
                "Use of highly technical jargon",
                "Lengthy and detailed explanations",
                "Clarity, structure, and appropriate tone",
        ...
        },
        {
            ...
            "options": [
                ...
                "Tailoring your message to your audience's background and understanding",
                "Avoiding visual aids to keep it simple",
                "Focusing only on your own communication style",
            ],
