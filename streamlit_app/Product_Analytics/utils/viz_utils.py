...
def plot_boxplot(
    data: np.ndarray, title: str = "Boxplot", ylabel: str = "Value"
) -> plt.Figure:
...
def plot_correlation_heatmap(
    corr_matrix: pd.DataFrame, title: str = "Correlation Heatmap", annot: bool = True
) -> plt.Figure:
...
def plot_multiple_boxplots(
    data_sets: dict, title: str = "Multiple Boxplots", ylabel: str = "Value"
) -> plt.Figure:
