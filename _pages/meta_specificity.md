...
<div class="section" id="meta-specificity">
  ...
  <div class="card" id="meta-data-science-culture">
    ...
    <p>Summary of working at scale, collaboration, and pace of innovation.</p>
  </div>

  <div class="card" id="internal-tools-technologies">
    <h3>3. Internal Tools and Technologies (General Overview)</h3>
    <p>Overview of Hadoop, Hive, Spark, Presto, experimentation platforms, visualization tools.</p>
  </div>

  <div class="card" id="product-deep-dives">
    <h3>4. Product Deep Dives (Examples)</h3>
    <p>Examples covering Facebook, Instagram, WhatsApp, and product-specific metrics and questions.</p>
  </div>
